...
test('test', async ({ page }) => {
  ...
  await page.getByText('Gender Mainstreaming Made Easy Esfera: MunicipalIdioma: ENTipo: ManualFormato: P').click();
  await page.getByText('Gender Equality Strategy 2018-2021 Esfera: GlobalIdioma: ENTipo: FerramentasForm').click();
  await page.getByText('Ops! nenhum resultado encontrado!').click();
});